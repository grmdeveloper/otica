@extends('dashboard',['titulo'=>'Dashboard','active'=>'visaoGeral'])
	...
	@endif
	<br>
	<a href="cadastrarmodelo" class='btn btn-primary btn-group'>Cadastrar Modelo</a>
	
	<a href="cadastrarcliente" class='btn btn-primary btn-group'>Cadastrar Cliente</a>

	<a href="cadastrarvenda" class='btn btn-primary btn-group'
